...
%% extract data of Nepal and India
row_nep = [];
row_ind = [];
i = 1; j = 1; k = 1;
Data_Nep = [];
...
% first wave
X1_Nep =  Data_Nep(cpt_Nep(1):cpt_Nep(3),5);          % deaths in first wave
X1_Ind = Data_Ind(cpt_Ind(1):cpt_Ind(3),5);
...
% second wave
X2_Nep =  Data_Nep(cpt_Nep(4):end,5);          % cases in first wave
X2_Ind = Data_Ind(cpt_Ind(4):cpt_Ind(end),5);
